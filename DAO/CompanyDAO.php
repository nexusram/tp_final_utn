...
public function Add($company)
{
    try
    {
        $query = "INSERT INTO ".$this->tableName." (CompanyName, BusinessName, CompanyAdress,cuil,telephone,email,web ) VALUES (:CompanyName, :BusinessName, :CompanyAdress,:cuil,:telephone,:email,:web);";
...
/*
    ...
    public function Modify( $CompanyName, $BusinessName, $CompanyAdress,$id_company, $telephone, $email, $web,$cuil)
    {   
       
        $this->connection = Connection::GetInstance();
        
        $consulta= "UPDATE company
        SET CompanyName = '$CompanyName', BusinessName = '$BusinessName', CompanyAdress = '$CompanyAdress',cuil = '$cuil', telephone = $telephone, email = '$email', web = '$web'
