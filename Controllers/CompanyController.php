...
class CompanyController
{
    ...
    public function NewAdd($CompanyName, $BusinessName, $CompanyAdress, $cuil, $telephone, $email, $web)
    {
        $company = new Company();
    ...
    public function companyNew($CompanyName, $BusinessName, $CompanyAdress, $cuil, $telephone, $email, $web)
    {


        $company = $this->NewAdd($CompanyName, $BusinessName, $CompanyAdress, $cuil, $telephone, $email, $web);
    ...
    public function CompanyMody($CompanyName, $BusinessName, $CompanyAdress, $id_company, $cuil, $telephone, $email, $web)
    {

        $this->companyDAO->Modify($CompanyName, $BusinessName, $CompanyAdress, $id_company, $telephone, $email, $web, $cuil);
